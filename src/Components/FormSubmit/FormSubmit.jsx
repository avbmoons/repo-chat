...
export function FormSubmit({onSubmit}){
    ...
    return (
        <form className="Form-submit" onSubmit={handleSubmit}>
            ...
            <TextField id="outlined-basic" label="your message here..." variant="outlined" className="Submit-input" inputRef={ref} value={value} onChange={handleChange} focuced={"true"} />
